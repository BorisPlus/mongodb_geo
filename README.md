...
В результате в MongoDB в коллекции `meteorites` в атрибутах `location` содержится информация о местоположении 38400 из 45716 метеоритах. 
...
Спасибо курсам <a target="_blank" href="https://otus.ru/">"OTUS"</a> за приобретенный опыт Fullstack-разработки (Python, Javascript, MongoDB).
